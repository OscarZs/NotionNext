...
const BLOG = {
  ...
  WIDGET_PET_LINK: 'https://imuncle.github.io/live2d/model/Violet/14.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2555218682', // 对应歌单的 id
